...
public class MenuManagement implements IConfig {
    ...
    public void MenuProjectManagement() {
        ...
        System.out.println("5. Find project by tên");
        ...
        System.out.println("9. List employee của project");
        ...
        switch (choice) {
            ...
            case "2" -> {
                try {
                    ...
                    System.out.println("Enter new leader id: ");
                    Employee employee = employeeManagement.searchById(myInp.nextLine());
    ...
    public void MenuEmployeeManagement() {
        ...
        switch (choice) {
            case "1" -> {
                ...
                } catch (InvalidNameException | InvalidDateException | InvalidEmailException | ParseException e) {
                    System.err.println(e.getMessage());
            ...
            case "7" -> {
                ...
                System.out.printf("List of employee have name: %s", name.toUpperCase());
            ...
            case "8" -> {
                ...
                try {
                    ...
                    System.out.printf("List of Employee have DOB  %s", dob);
            ...
            case "10" -> {
                try {
                    ...
                    System.out.printf("List of employee in %d year old", age);
            ...
            case "11" -> {
                try {
                    ...
                    System.out.printf("Employee (%d - %d)", fromAge, toAge);
    ...
    public void MenuOfficeManagement() {
        ...
        System.out.println("3. Add employee vào office");
        ...
        switch (choice) {
            ...
            case "6" -> System.out.println("Finish Office Management");
            default -> {
                System.out.println("Invalid choice. Try Again!!");
                MenuProjectManagement();
            }
    ...
    public void MenuRelationManagement() {
        ...
        System.out.println("1. Show relation information of employee");
